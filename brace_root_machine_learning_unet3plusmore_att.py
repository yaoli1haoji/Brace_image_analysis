...
from Unet3plus import unet3plus,unet3plusmore,unet3plus_deepsup,unet3plusmore_deepsup,unet3plusmore_att,unet3plusmore_att_full
...
checkpoint_filepath =  "Unet3plusmore_att" + str(epoch) + "_epoch_" + "best_save_with_sample_weight_" + str(Date_name) + "_" + str(batchsize) + "_batch_size_" + str(initial_learning_rate) + "_LR_Decay_gpu.hdf5"
...
def get_unet3plusmore_deepsup():
    return unet3plusmore_deepsup(input_shape=(IMG_HEIGHT,IMG_WIDTH,IMG_CHANNELS), output_channels = n_classes,training=True)

def get_unet3plusmore():
    return unet3plusmore(input_shape=(IMG_HEIGHT,IMG_WIDTH,IMG_CHANNELS), output_channels = n_classes)

def get_unet3plusmore_att():
    return unet3plusmore_att(input_shape=(IMG_HEIGHT,IMG_WIDTH,IMG_CHANNELS), output_channels = n_classes)

def get_unet3plusmore_att_full():
    return unet3plusmore_att_full(input_shape=(IMG_HEIGHT,IMG_WIDTH,IMG_CHANNELS), output_channels = n_classes)
...
#with strategy.scope():
  #model = get_unet3plusmore_deepsup()
  #model.compile(optimizer=optim, loss=total_loss, metrics=metrics)

#with strategy.scope():
  #model = get_unet3plusmore()
  #model.compile(optimizer=optim, loss=total_loss, metrics=metrics)


#with strategy.scope():
  #model = get_unet3plusmore_att()
  #model.compile(optimizer=optim, loss=total_loss, metrics=metrics)
...
plt.legend()
plt.show()
#val_loss_save_name = "Une3plusmore_deep_supervision" + "_backbone_model_" + str(epoch) + "_epoch_" + str(Date_name) + "_" + str(batchsize) + "_batch_size_" + str(initial_learning_rate) + "_val_loss.png"
val_loss_save_name = "Une3plusmore_att_full" + "_backbone_model_" + str(epoch) + "_epoch_" + str(Date_name) + "_" + str(batchsize) + "_batch_size_" + str(initial_learning_rate) + "_val_loss.png"
...
plt.legend()
plt.show()
#val_IOU_save_name = "Unet3plusmore_deep_supervision" + "_backbone_model_" + str(epoch) + "_epoch_" + str(Date_name) + "_" + str(batchsize) + "_batch_size_" + str(initial_learning_rate) + "_val_IOU.jpg"
val_IOU_save_name = "Unet3plusmore_att_full" + "_backbone_model_" + str(epoch) + "_epoch_" + str(Date_name) + "_" + str(batchsize) + "_batch_size_" + str(initial_learning_rate) + "_val_IOU.jpg"
