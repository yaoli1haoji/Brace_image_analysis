...
from Unet3plus import unet3plus,unet3plusmore,unet3plus_deepsup,unet3plusmore_deepsup
...
#checkpoint_filepath =  "Unet3plus_deepsup_model_" + str(epoch) + "_epoch_" + "best_save_with_sample_weight_" + str(Date_name) + "_" + str(batchsize) + "_batch_size_" + str(initial_learning_rate) + "_LR_Decay_gpu.hdf5"

checkpoint_filepath =  "Unet3plus" + str(epoch) + "_epoch_" + "best_save_with_sample_weight_" + str(Date_name) + "_" + str(batchsize) + "_batch_size_" + str(initial_learning_rate) + "_LR_Decay_gpu.hdf5"
...
plt.legend()
plt.show()
val_loss_save_name = "Une3plus" + "_backbone_model_" + str(epoch) + "_epoch_" + str(Date_name) + "_" + str(batchsize) + "_batch_size_" + str(initial_learning_rate) + "_val_loss.png"
#val_loss_save_name = "Une3plus_deep_supervision" + "_backbone_model_" + str(epoch) + "_epoch_" + str(Date_name) + "_" + str(batchsize) + "_batch_size_" + str(initial_learning_rning_rate) + "_val_loss.png"
...
plt.legend()
plt.show()
val_IOU_save_name = "Unet3plus" + "_backbone_model_" + str(epoch) + "_epoch_" + str(Date_name) + "_" + str(batchsize) + "_batch_size_" + str(initial_learning_rate) + "_val_IOU.jpg"
#val_IOU_save_name = "Unet3plus_deep_supervision" + "_backbone_model_" + str(epoch) + "_epoch_" + str(Date_name) + "_" + str(batchsize) + "_batch_size_" + str(initial_learning_rate) + "_val_IOU.jpg"
