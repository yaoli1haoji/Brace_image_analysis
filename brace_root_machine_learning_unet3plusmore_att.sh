...
#SBATCH --output=Unet3plusmore_att.%j.out    # Standard output log
#SBATCH --error=Unet3plusmore_att.%j.err     # Standard error log
...
python brace_root_machine_learning_unet3plusmore_att.py
