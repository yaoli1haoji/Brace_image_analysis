...
from Unet_models import Attention_ResUNet, UNet, Attention_UNet, dice_coef, dice_coef_loss, jacard_coef
...
with strategy.scope():
  ...
  model1 = Attention_UNet(input_shape,NUM_CLASSES=n_classes, dropout_rate=0.1)
...
print("This is the result for attention_unet model with LR = " + str(initial_learning_rate) + " batch size = " + str(batchsize) + " epoch = " + str(epoch))
